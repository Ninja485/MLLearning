...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    current_measure = temperature * neutrons_produced_per_second
    if current_measure < 0.9 * threshold:
        return "LOW"
    elif 0.9 * threshold <= current_measure and current_measure <= 1.1*threshold:
        return "NORMAL"
    else:
        return "DANGER"
